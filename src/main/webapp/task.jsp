...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="content-modal" >
			...
			<form class="modal" id="form-update" >
				<div class="form-group">
					<label class="col-sm-3">Project</label> 
					<select id="idProject" class="form-control-line">
				...
				<div class="form-group">
					<label class="col-sm-3">Job Name</label> 
					<input type="text"
						class="form-control-line" id="nameJob" required> 
				</div>
				<div class="form-group">
					<label class="col-sm-3">Staff</label> 
					<select id="idUser" class="form-control-line">
                                ...
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-sm btn-primary btn-Update" idUpdate="${item.id}">Sửa</a>
                                                <a href="#" class="btn btn-sm btn-danger btn-Delete" idDelete="${item.id}" >Xóa</a>
