...
<body>
	...
	<div id="wrapper">
		...
		<div id="content-modal">
			...
			<form class="modal" id="form-update" style="height: 300px">
				<div class="form-group">
					<label class="col-sm-3">Project</label> <input type="text"
						class="form-control-line" id="nameProject" required>
				</div>
				<div class="form-group">
					<label class="col-sm-3">Start Date</label> <input type="date"
						class="form-control-line" id="startDate" required>
				</div>
				<div class="form-group">
					<label class="col-sm-3">End Date</label> <input type="date"
						class="form-control-line" id="endDate" required>
				</div>
									...
									<tbody>
										<c:forEach var="item" items="${listProject}">
											<tr>
												...
												<td>${item.endDate}</td>
												<td><a href="#" class="btn btn-sm btn-primary btn-Update" idUpdate="${item.id}">Sửa</a>
													<a href="#" class="btn btn-sm btn-danger btn-Delete" idDelete="${item.id}">Xóa</a> <a
