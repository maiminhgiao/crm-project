                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên công việc"
                                            class="form-control form-control-line" id="nameProject"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input type="date" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line" id="startDate"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input type="date" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line" id="endDate"> </div>
                                </div>
                                <h3>Ngày kết thúc không hợp lệ</h3>
                                <div class="form-group">
                                    <div class="col-sm-12">
