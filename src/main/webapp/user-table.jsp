		...
		<div id="content-modal" >
			...
			<form class="modal" id="form-update" >
				<div class="form-group">
					...
					<input type="text"
						class="form-control-line" id="fullName" required> 
				</div>
				<div class="form-group">
					<label class="col-sm-3">Email</label> 
					<input type="email"
						class="form-control-line" id="email" required> 
				</div>
				<div class="form-group">
					<label class="col-sm-3">Password</label> 
					<input type="text"
						class="form-control-line" id="pwd" required> 
				</div>
				<div class="form-group">
					<label class="col-sm-3">Phone No</label> 
					<input type="text"
						class="form-control-line" id="phone" required> 
				</div>
				<div class="form-group">
                                ...
                                <table class="table" id="example">
                                    ...
                                    <c:forEach var="item" items="${listUser}">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-sm btn-primary update-btn" idUpdate="${item.id}">Sửa</a>
                                                <a href="#" class="btn btn-sm btn-danger delete-btn" idDelete="${item.id}">Xóa</a>
                                                <a href="#" class="btn btn-sm btn-info view-btn" idView="${item.id}">Xem</a>
                                            </td>
                                        </tr>
                                      </c:forEach>
                                    </tbody>
