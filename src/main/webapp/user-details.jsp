                            ...
                            <div class="user-bg"> <img width="100%" alt="user" src="plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="plugins/images/users/meme.jpg"
                                                class="thumb-lg img-circle" alt="img"></a>
                                        <h4 class="text-white" id="fullNameView">Hello</h4>
                                        <h5 class="text-white" id="emailView">info.teo</h5>
                                    </div>
                                </div>
                            </div>
