            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" id="form-add">
                                <div class="form-group">
                                    <label class="col-md-12">Dự án</label>
                                    <div class="col-md-12">
                                        <select id="idProject" class="form-control form-control-line">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên công việc"
                                            class="form-control form-control-line" id="nameJob">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Người thực hiện</label>
                                    <div class="col-md-12">
                                        <select id="idUser" class="form-control form-control-line">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line" id="startDate"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line" id="endDate"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
