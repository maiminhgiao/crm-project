                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" id="form-add">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Johnathan Doe"
                                            class="form-control form-control-line" id="fullName" required> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="password" placeholder="Your Password" class="form-control form-control-line" id="pwd" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="123 456 7890"
                                            class="form-control form-control-line" id="phone"> </div>
                                </div>
                                <div class="form-group">
